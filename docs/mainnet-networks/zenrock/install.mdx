...
### Clone Zenrock repo and build zenrockd v6.4.2
...
```js
cd $HOME
mkdir -p ~/.zrchain/cosmovisor/upgrades/v6.4.2/bin
mv $HOME/go/bin/zenrockd ~/.zrchain/cosmovisor/upgrades/v6.4.2/bin/
```
