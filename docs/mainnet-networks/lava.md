...
###### Chain ID: `lava-mainnet-1` | Current Node Version: `v2.2.0`
...
<CardLayout autoFitEnabled={true}>
    ...
    <SmallCard to="http://lava-grpc.noders.services:37090" header={{label: "gRPC Endpoint", translateId: "grpc-endpoint"}}/>
</CardLayout>
