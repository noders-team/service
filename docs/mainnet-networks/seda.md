...
<CardLayout autoFitEnabled={true}>
    <Card
        to="https://seda.explorers.guru/validator/sedavaloper1ur9sw064p8zs793cn20y6qapaz4rsccmcjv96y"
        header={{
            label: "[NODERS]TEAM",
...
<CardLayout autoFitEnabled={true}>
    <SmallCard to="https://seda-rpc.noders.services" header={{label: "RPC Endpoint", translateId: "rpc-endpoint"}}/>
    <SmallCard to="https://seda-api.noders.services" header={{label: "API Endpoint", translateId: "api-endpoint"}}/>
    
    <SmallCard to="https://seda-grpc.noders.services:443" header={{label: "gRPC Endpoint", translateId: "grpc-endpoint"}}/>
