...
### Clone Zenrock repo and build zenrockd v6.5.5
...
```js
cd $HOME
mkdir -p ~/.zrchain/cosmovisor/upgrades/v6.5.5/bin
mv $HOME/go/bin/zenrockd ~/.zrchain/cosmovisor/upgrades/v6.5.5/bin/
```
