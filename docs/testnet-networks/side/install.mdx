...
### Clone Side repo and build sided v2.0.0-rc.5
...
```js
cd $HOME
mkdir -p ~/.side/cosmovisor/upgrades/v2.0.0-rc.5/bin
mv $HOME/go/bin/sided ~/.side/cosmovisor/upgrades/v2.0.0-rc.5/bin/
```
