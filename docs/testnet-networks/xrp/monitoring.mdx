...
This guide helps you set up comprehensive monitoring for your XRP validator node using Prometheus and Grafana.

### Prerequisites

- Docker and Docker Compose installed
- XRP node running with metrics enabled
- Ports 9090 (Prometheus) and 3000 (Grafana) available

### Step 1: Enable Metrics in XRP Node
...
```bash
mkdir -p $HOME/xrp-monitoring
cd $HOME/xrp-monitoring
```
...
services:
  ...
  node-exporter:
    ...
    container_name: xrp-node-exporter
    ports:
      - "9100:9100"
    command:
      - '--path.rootfs=/host'
...
groups:
  - name: xrp-validator-alerts
    rules:
      - alert: ValidatorDown
        expr: up{job="xrp-validator"} == 0
        for: 1m
        labels:
          severity: critical
          chain: XRP
        annotations:
          summary: "XRP validator is down"
          description: "XRP validator has been down for more than 1 minute"
      ...
      - alert: NodeNotSyncing
        ...
        labels:
          ...
          chain: XRP
        annotations:
          summary: "XRP node is not syncing"
          description: "XRP node is behind by {{ $value }} blocks"
      ...
      - alert: MissedBlocks
        ...
        labels:
          ...
          chain: XRP
        annotations:
          summary: "XRP validator missing blocks"
          description: "XRP validator has missed {{ $value }} blocks"
      ...
      - alert: HighMemoryUsage
        ...
        labels:
          ...
          chain: XRP
        annotations:
          summary: "High memory usage on XRP validator"
      ...
      - alert: DiskSpaceLow
        ...
        labels:
          ...
          chain: XRP
        annotations:
          summary: "Low disk space on XRP validator"
...
Import our XRP validator dashboard from NODERS:
...
- **Process Exporter**: exrpd process metrics  
