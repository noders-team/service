...
```js
curl https://snapshots-t.noders.services/arkeo/genesis.json -o ~/.arkeo/config/genesis.json
curl https://snapshots-t.noders.services/arkeo/addrbook.json -o ~/.arkeo/config/addrbook.json
```
