...
### Clone ZeroGravity repo and build 0gchaind v0.2.0-alpha.4-726-g680c0d7e2

```js
cd $HOME
git clone https://github.com/0glabs/0g-chain.git
cd 0g-chain
git checkout v0.2.0-alpha.4-726-g680c0d7e2
```
...
```js
cd $HOME
mkdir -p ~/.0gchain/cosmovisor/upgrades/v0.2.0-alpha.4-726-g680c0d7e2/bin
mv $HOME/go/bin/0gchaind ~/.0gchain/cosmovisor/upgrades/v0.2.0-alpha.4-726-g680c0d7e2/bin/
```
