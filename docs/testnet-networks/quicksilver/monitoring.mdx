...
<PageTitle
  ...
  title="Quicksilver Monitoring Setup"
  chainId="rhye-3"
  version="v1.8.0-rc.1"
/>
...
This guide helps you set up comprehensive monitoring for your Quicksilver validator node using Prometheus and Grafana.

### Prerequisites

- Docker and Docker Compose installed
- Quicksilver node running with metrics enabled
- Ports 9090 (Prometheus) and 3000 (Grafana) available

### Step 1: Enable Metrics in Quicksilver Node
...
Restart your quicksilverd service:
...
```bash
mkdir -p $HOME/quicksilver-monitoring
cd $HOME/quicksilver-monitoring
```
...
services:
  prometheus:
    ...
    container_name: quicksilver-prometheus
    ports:
      - "9090:9090"
    volumes:
  ...
  grafana:
    ...
    container_name: quicksilver-grafana
    ports:
      - "3000:3000"
    environment:
  ...
  node-exporter:
    ...
    container_name: quicksilver-node-exporter
    ports:
      - "9100:9100"
    command:
      - '--path.rootfs=/host'
...
scrape_configs:
  - job_name: 'quicksilver-validator'
    static_configs:
...
groups:
  - name: quicksilver-validator-alerts
    rules:
      - alert: ValidatorDown
        expr: up{job="quicksilver-validator"} == 0
        for: 1m
        labels:
          severity: critical
          chain: Quicksilver
        annotations:
          summary: "Quicksilver validator is down"
          description: "Quicksilver validator has been down for more than 1 minute"
      ...
      - alert: NodeNotSyncing
        ...
        labels:
          ...
          chain: Quicksilver
        annotations:
          summary: "Quicksilver node is not syncing"
          description: "Quicksilver node is behind by {{ $value }} blocks"
      ...
      - alert: MissedBlocks
        ...
        labels:
          ...
          chain: Quicksilver
        annotations:
          summary: "Quicksilver validator missing blocks"
          description: "Quicksilver validator has missed {{ $value }} blocks"
      ...
      - alert: HighMemoryUsage
        ...
        labels:
          ...
          chain: Quicksilver
        annotations:
          summary: "High memory usage on Quicksilver validator"
      ...
      - alert: DiskSpaceLow
        ...
        labels:
          ...
          chain: Quicksilver
        annotations:
          summary: "Low disk space on Quicksilver validator"
...
Import our Quicksilver validator dashboard from NODERS:
...
- **Process Exporter**: quicksilverd process metrics
