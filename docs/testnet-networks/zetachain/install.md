...
sudo systemctl enable zetacore.service.service
```
...
```js
curl -Ls https://config-t.noders.services/zetachain/genesis.json > ~/.zetacored/config/genesis.json
curl -Ls https://config-t.noders.services/zetachain/addrbook.json > ~/.zetacored/config/addrbook.json
```
### Add peers
```js
...
sed -i -e "s%^address = \"tcp://0.0.0.0:1317\"%address = \"tcp://0.0.0.0:14717\"%; s%^address = \":8080\"%address = \":14780\"%; s%^address = \"0.0.0.0:9090\"%address = \"0.0.0.0:14790\"%; s%^address = \"0.0.0.0:9091\"%address = \"0.0.0.0:14791\"%; s%:8545%:14745%; s%:8546%:14746%; s%:6065%:14765%" ~/.zetacored/config/app.toml
```

### Start node and check logs
```js
sudo systemctl start zetacore.service.service && sudo journalctl -u zetacore.service.service -f --no-hostname -o cat
```