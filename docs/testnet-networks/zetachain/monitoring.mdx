...
<PageTitle
  ...
  title="Zetachain Monitoring Setup"
...
This guide helps you set up comprehensive monitoring for your Zetachain validator node using Prometheus and Grafana.

### Prerequisites

- Docker and Docker Compose installed
- Zetachain node running with metrics enabled
- Ports 9090 (Prometheus) and 3000 (Grafana) available

### Step 1: Enable Metrics in Zetachain Node
...
Restart your zetacored service:
...
```bash
mkdir -p $HOME/zetachain-monitoring
cd $HOME/zetachain-monitoring
```
...
services:
  prometheus:
    ...
    container_name: zetachain-prometheus
    ports:
      - "9090:9090"
    volumes:
  ...
  grafana:
    ...
    container_name: zetachain-grafana
    ports:
      - "3000:3000"
    environment:
  ...
  node-exporter:
    ...
    container_name: zetachain-node-exporter
    ports:
      - "9100:9100"
    command:
      - '--path.rootfs=/host'
...
groups:
  - name: zetachain-validator-alerts
    rules:
      - alert: ValidatorDown
        expr: up{job="zetachain-validator"} == 0
        for: 1m
        labels:
          severity: critical
          chain: Zetachain
        annotations:
          summary: "Zetachain validator is down"
          description: "Zetachain validator has been down for more than 1 minute"
      ...
      - alert: NodeNotSyncing
        ...
        labels:
          ...
          chain: Zetachain
        annotations:
          summary: "Zetachain node is not syncing"
          description: "Zetachain node is behind by {{ $value }} blocks"
      ...
      - alert: MissedBlocks
        ...
        labels:
          ...
          chain: Zetachain
        annotations:
          summary: "Zetachain validator missing blocks"
          description: "Zetachain validator has missed {{ $value }} blocks"
      ...
      - alert: HighMemoryUsage
        ...
        labels:
          ...
          chain: Zetachain
        annotations:
          summary: "High memory usage on Zetachain validator"
      ...
      - alert: DiskSpaceLow
        ...
        labels:
          ...
          chain: Zetachain
        annotations:
          summary: "Low disk space on Zetachain validator"
...
Import our Zetachain validator dashboard from NODERS:
...
- **Process Exporter**: zetacored process metrics
