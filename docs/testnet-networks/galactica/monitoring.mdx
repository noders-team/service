...
<PageTitle
  ...
  title="Galactica Monitoring Setup"
...
This guide helps you set up comprehensive monitoring for your Galactica validator node using Prometheus and Grafana.

### Prerequisites

- Docker and Docker Compose installed
- Galactica node running with metrics enabled
- Ports 9090 (Prometheus) and 3000 (Grafana) available

### Step 1: Enable Metrics in Galactica Node
...
Restart your galacticad service:
...
```bash
mkdir -p $HOME/galactica-monitoring
cd $HOME/galactica-monitoring
```
...
services:
  prometheus:
    ...
    container_name: galactica-prometheus
    ports:
      - "9090:9090"
    volumes:
  ...
  grafana:
    ...
    container_name: galactica-grafana
    ports:
      - "3000:3000"
    environment:
  ...
  node-exporter:
    ...
    container_name: galactica-node-exporter
    ports:
      - "9100:9100"
    command:
      - '--path.rootfs=/host'
...
groups:
  - name: galactica-validator-alerts
    rules:
      - alert: ValidatorDown
        expr: up{job="galactica-validator"} == 0
        for: 1m
        labels:
          severity: critical
          chain: Galactica
        annotations:
          summary: "Galactica validator is down"
          description: "Galactica validator has been down for more than 1 minute"
      ...
      - alert: NodeNotSyncing
        ...
        labels:
          ...
          chain: Galactica
        annotations:
          summary: "Galactica node is not syncing"
          description: "Galactica node is behind by {{ $value }} blocks"
      ...
      - alert: MissedBlocks
        ...
        labels:
          ...
          chain: Galactica
        annotations:
          summary: "Galactica validator missing blocks"
          description: "Galactica validator has missed {{ $value }} blocks"
      ...
      - alert: HighMemoryUsage
        ...
        labels:
          ...
          chain: Galactica
        annotations:
          summary: "High memory usage on Galactica validator"
      ...
      - alert: DiskSpaceLow
        ...
        labels:
          ...
          chain: Galactica
        annotations:
          summary: "Low disk space on Galactica validator"
...
Import our Galactica validator dashboard from NODERS:
...
- **Process Exporter**: galacticad process metrics  
