...
<CardLayout autoFitEnabled={true}>
    <SmallCard to="https://kopi-t-rpc.noders.services" header={{label: "RPC Endpoint", translateId: "rpc-endpoint"}}/>
    <SmallCard to="https://kopi-t-api.noders.services" header={{label: "API Endpoint", translateId: "api-endpoint"}}/>
    
    <SmallCard to="http://kopi-t-grpc.noders.services:27690" header={{label: "gRPC Endpoint", translateId: "grpc-endpoint"}}/>
</CardLayout>