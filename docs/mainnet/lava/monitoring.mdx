...
This guide helps you set up comprehensive monitoring for your Lava validator node using Prometheus and Grafana.

### Prerequisites

- Docker and Docker Compose installed
- Lava node running with metrics enabled
- Ports 9090 (Prometheus) and 3000 (Grafana) available

### Step 1: Enable Metrics in Lava Node
...
```bash
mkdir -p $HOME/lava-monitoring
cd $HOME/lava-monitoring
```
...
services:
  ...
  node-exporter:
    ...
    container_name: lava-node-exporter
    ports:
      - "9100:9100"
    command:
      - '--path.rootfs=/host'
...
groups:
  - name: lava-validator-alerts
    rules:
      - alert: ValidatorDown
        expr: up{job="lava-validator"} == 0
        for: 1m
        labels:
          severity: critical
          chain: Lava
        annotations:
          summary: "Lava validator is down"
          description: "Lava validator has been down for more than 1 minute"
      ...
      - alert: NodeNotSyncing
        ...
        labels:
          ...
          chain: Lava
        annotations:
          summary: "Lava node is not syncing"
          description: "Lava node is behind by {{ $value }} blocks"
      ...
      - alert: MissedBlocks
        ...
        labels:
          ...
          chain: Lava
        annotations:
          summary: "Lava validator missing blocks"
          description: "Lava validator has missed {{ $value }} blocks"
      ...
      - alert: HighMemoryUsage
        ...
        labels:
          ...
          chain: Lava
        annotations:
          summary: "High memory usage on Lava validator"
      ...
      - alert: DiskSpaceLow
        ...
        labels:
          ...
          chain: Lava
        annotations:
          summary: "Low disk space on Lava validator"
...
Import our Lava validator dashboard from NODERS:
...
- **Process Exporter**: lavad process metrics
