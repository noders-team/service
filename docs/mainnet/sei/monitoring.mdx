...
This guide helps you set up comprehensive monitoring for your Sei validator node using Prometheus and Grafana.

### Prerequisites

- Docker and Docker Compose installed
- Sei node running with metrics enabled
- Ports 9090 (Prometheus) and 3000 (Grafana) available

### Step 1: Enable Metrics in Sei Node
...
```bash
mkdir -p $HOME/sei-monitoring
cd $HOME/sei-monitoring
```
...
groups:
  - name: sei-validator-alerts
    rules:
      - alert: ValidatorDown
        expr: up{job="sei-validator"} == 0
        for: 1m
        labels:
          severity: critical
          chain: Sei
        annotations:
          summary: "Sei validator is down"
          description: "Sei validator has been down for more than 1 minute"
      ...
      - alert: NodeNotSyncing
        ...
        labels:
          ...
          chain: Sei
        annotations:
          summary: "Sei node is not syncing"
          description: "Sei node is behind by {{ $value }} blocks"
      ...
      - alert: MissedBlocks
        ...
        labels:
          ...
          chain: Sei
        annotations:
          summary: "Sei validator missing blocks"
          description: "Sei validator has missed {{ $value }} blocks"
      ...
      - alert: HighMemoryUsage
        ...
        labels:
          ...
          chain: Sei
        annotations:
          summary: "High memory usage on Sei validator"
      ...
      - alert: DiskSpaceLow
        ...
        labels:
          ...
          chain: Sei
        annotations:
          summary: "Low disk space on Sei validator"
...
Import our Sei validator dashboard from NODERS:
...
- **Process Exporter**: seid process metrics
