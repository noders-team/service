...
This guide helps you set up comprehensive monitoring for your Aura validator node using Prometheus and Grafana.

### Prerequisites

- Docker and Docker Compose installed
- Aura node running with metrics enabled
- Ports 9090 (Prometheus) and 3000 (Grafana) available

### Step 1: Enable Metrics in Aura Node
...
```bash
mkdir -p $HOME/aura-monitoring
cd $HOME/aura-monitoring
```
    ...
    rules:
      - alert: ValidatorDown
        ...
        labels:
          ...
          chain: Aura
        annotations:
          summary: "Aura validator is down"
          description: "Aura validator has been down for more than 1 minute"
      ...
      - alert: NodeNotSyncing
        ...
        labels:
          ...
          chain: Aura
        annotations:
          summary: "Aura node is not syncing"
          description: "Aura node is behind by {{ $value }} blocks"
      ...
      - alert: MissedBlocks
        ...
        labels:
          ...
          chain: Aura
        annotations:
          summary: "Aura validator missing blocks"
          description: "Aura validator has missed {{ $value }} blocks"
      ...
      - alert: HighMemoryUsage
        ...
        labels:
          ...
          chain: Aura
        annotations:
          summary: "High memory usage on Aura validator"
      ...
      - alert: DiskSpaceLow
        ...
        labels:
          ...
          chain: Aura
        annotations:
          summary: "Low disk space on Aura validator"
...
Import our Aura validator dashboard from NODERS:
...
- **Process Exporter**: aurad process metrics
