...
```js
mkdir -p ~/.celestia-app/cosmovisor/upgrades/v4.0.7-arabica/bin
mv build/celestia-appd ~/.celestia-app/cosmovisor/upgrades/v4.0.7-arabica/bin/
rm -rf build
```
