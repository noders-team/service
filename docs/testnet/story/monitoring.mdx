...
This guide helps you set up comprehensive monitoring for your Story validator node using Prometheus and Grafana.

### Prerequisites

- Docker and Docker Compose installed
- Story node running with metrics enabled
- Ports 9090 (Prometheus) and 3000 (Grafana) available

### Step 1: Enable Metrics in Story Node
...
```bash
mkdir -p $HOME/story-monitoring
cd $HOME/story-monitoring
```
...
groups:
  - name: story-validator-alerts
    rules:
      - alert: ValidatorDown
        expr: up{job="story-validator"} == 0
        for: 1m
        labels:
          severity: critical
          chain: Story
        annotations:
          summary: "Story validator is down"
          description: "Story validator has been down for more than 1 minute"
      ...
      - alert: NodeNotSyncing
        ...
        labels:
          ...
          chain: Story
        annotations:
          summary: "Story node is not syncing"
          description: "Story node is behind by {{ $value }} blocks"
      ...
      - alert: MissedBlocks
        ...
        labels:
          ...
          chain: Story
        annotations:
          summary: "Story validator missing blocks"
          description: "Story validator has missed {{ $value }} blocks"
      ...
      - alert: HighMemoryUsage
        ...
        labels:
          ...
          chain: Story
        annotations:
          summary: "High memory usage on Story validator"
      ...
      - alert: DiskSpaceLow
        ...
        labels:
          ...
          chain: Story
        annotations:
          summary: "Low disk space on Story validator"
...
Import our Story validator dashboard from NODERS:
...
- **Process Exporter**: story process metrics  
