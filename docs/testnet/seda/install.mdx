...
### Clone Seda repo and build sedad v1.0.0-rc.6
...
```js
cd $HOME
mkdir -p ~/.sedad/cosmovisor/upgrades/v1.0.0-rc.6/bin
mv $HOME/go/bin/sedad ~/.sedad/cosmovisor/upgrades/v1.0.0-rc.6/bin/
```
