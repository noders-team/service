...
<PageTitle
  ...
  title="Mantra Installation Guide"
...
### Clone Mantra repo and build mantrachaind v5.0.0-rc0
...
```js
cd $HOME
mkdir -p ~/.mantrachaind/cosmovisor/upgrades/v5.0.0-rc0/bin
mv $HOME/go/bin/mantrachaind ~/.mantrachaind/cosmovisor/upgrades/v5.0.0-rc0/bin/
```
...
```js
curl https://snapshots.noders.services/mantra/genesis.json -o ~/.mantrachaind/config/genesis.json
