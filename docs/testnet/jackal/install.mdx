...
### Clone Jackal repo and build canined v4.6.0-beta.1
...
```js
cd $HOME
mkdir -p ~/.canine/cosmovisor/upgrades/v4.6.0-beta.1/bin
mv $HOME/go/bin/canined ~/.canine/cosmovisor/upgrades/v4.6.0-beta.1/bin/
```
