...
function replacePageVariablesMacOs {
  # App
  sed -i '' "s|\[CHAIN_NAME\]|${CHAIN_NAME}|g" "$1" 2>/dev/null
  sed -i '' "s|\[CHAIN_SYSTEM_NAME\]|${CHAIN_SYSTEM_NAME}|g" "$1" 2>/dev/null
  sed -i '' "s|\[CHAIN_ICON\]|${CHAIN_ICON}|g" "$1" 2>/dev/null
  sed -i '' "s|\[CHAIN_SCOPE\]|${CHAIN_SCOPE}|g" "$1" 2>/dev/null
  sed -i '' "s|\[CHAIN_BACKGROUND_COLOR\]|${CHAIN_BACKGROUND_COLOR}|g" "$1" 2>/dev/null

  # NODERS
  escaped_stake_url=$(escapeSpecialChars "${STAKE_URL}")
  sed -i '' "s|\[STAKE_URL\]|${escaped_stake_url}|g" "$1" 2>/dev/null
  escaped_restake_url=$(escapeSpecialChars "${RESTAKE_URL}")
  sed -i '' "s|\[RESTAKE_URL\]|${escaped_restake_url}|g" "$1" 2>/dev/null
  sed -i '' "s|\[VALIDATOR_URL\]|${VALIDATOR_URL}|g" "$1" 2>/dev/null
  sed -i '' "s|\[EXPLORER_URL\]|${EXPLORER_URL}|g" "$1" 2>/dev/null
  sed -i '' "s|\[EXPLORER_IMAGE\]|${EXPLORER_IMAGE}|g" "$1" 2>/dev/null
  sed -i '' "s|\[FAUCET_URL\]|${FAUCET_URL}|g" "$1" 2>/dev/null
  sed -i '' "s|\[APP_URL\]|${APP_URL}|g" "$1" 2>/dev/null
  sed -i '' "s|\[APP_IMAGE\]|${APP_IMAGE}|g" "$1" 2>/dev/null

  # Blockchain
  sed -i '' "s|\[CHAIN_ID\]|${CHAIN_ID}|g" "$1" 2>/dev/null
  sed -i '' "s|\[CHAIN_DENOM_PRETTY\]|${CHAIN_DENOM_PRETTY}|g" "$1" 2>/dev/null
  sed -i '' "s|\[CHAIN_DENOM\]|${CHAIN_DENOM}|g" "$1" 2>/dev/null
  sed -i '' "s|\[CHAIN_FEES\]|${CHAIN_FEES}|g" "$1" 2>/dev/null

  # Binary
  sed -i '' "s|\[VERSION\]|${VERSION}|g" "$1" 2>/dev/null
  sed -i '' "s|\[DAEMON_NAME\]|${DAEMON_NAME}|g" "$1" 2>/dev/null
  sed -i '' "s|\[DAEMON_SERVICE\]|${DAEMON_SERVICE}|g" "$1" 2>/dev/null
  sed -i '' "s|\[DAEMON_HOME\]|${DAEMON_HOME}|g" "$1" 2>/dev/null

  # Endpoints
  sed -i '' "s|\[ENDPOINT_RPC\]|${ENDPOINT_RPC}|g" "$1" 2>/dev/null
  sed -i '' "s|\[ENDPOINT_API\]|${ENDPOINT_API}|g" "$1" 2>/dev/null
  sed -i '' "s|\[ENDPOINT_JRPC\]|${ENDPOINT_JRPC}|g" "$1" 2>/dev/null
  sed -i '' "s|\[ENDPOINT_GRPC\]|${ENDPOINT_GRPC}|g" "$1" 2>/dev/null
  sed -i '' "s|\[ENDPOINT_PEER\]|${ENDPOINT_PEER}|g" "$1" 2>/dev/null
  sed -i '' "s|\[ENDPOINT_COSMOSLIST\]|${ENDPOINT_COSMOSLIST}|g" "$1" 2>/dev/null
  sed -i '' "s|\[ENDPOINT_SEED\]|${ENDPOINT_SEED}|g" "$1" 2>/dev/null

  # Social
  sed -i '' "s|\[SOCIAL_WEBSITE\]|${SOCIAL_WEBSITE}|g" "$1" 2>/dev/null
  sed -i '' "s|\[SOCIAL_GITHUB\]|${SOCIAL_GITHUB}|g" "$1" 2>/dev/null
  sed -i '' "s|\[SOCIAL_DISCORD\]|${SOCIAL_DISCORD}|g" "$1" 2>/dev/null
  sed -i '' "s|\[SOCIAL_X\]|${SOCIAL_X}|g" "$1" 2>/dev/null
  sed -i '' "s|\[SOCIAL_TELEGRAM\]|${SOCIAL_TELEGRAM}|g" "$1" 2>/dev/null

  # Other
  sed -i '' "s|\[SNAPSHOT_URL\]|${SNAPSHOT_URL}|g" "$1" 2>/dev/null
  sed -i '' "s|\[GITHUB_FOLDER_NAME\]|${GITHUB_FOLDER_NAME}|g" "$1" 2>/dev/null
  sed -i '' "s|\[LIVE_PEERS_COUNT\]|${LIVE_PEERS_COUNT}|g" "$1" 2>/dev/null
  sed -i '' "s|\[LIVE_PEERS_ALL\]|${LIVE_PEERS_ALL}|g" "$1" 2>/dev/null
  sed -i '' "s|\[TIMESTAMP\]|${TIMESTAMP}|g" "$1" 2>/dev/null
  sed -i '' "s|\[SIZE\]|${SIZE}|g" "$1" 2>/dev/null
  sed -i '' "s|\[SNAP_LATEST_BLOCK\]|${SNAP_LATEST_BLOCK}|g" "$1" 2>/dev/null
  sed -i '' "s|\[SNAP_ARCHIVE_NAME\]|${SNAP_ARCHIVE_NAME}|g" "$1" 2>/dev/null
  sed -i '' "s|\[SNAP_ARCHIVE_LINK\]|${SNAP_ARCHIVE_LINK}|g" "$1" 2>/dev/null
  sed -i '' "s@\[SNAP_ARCHIVE_DOWNLOAD_COMMAND\]@${SNAP_ARCHIVE_DOWNLOAD_COMMAND}@g" "$1" 2>/dev/null
  sed -i '' "s|\[LIVE_PEERS_RANDOM\]|${LIVE_PEERS_RANDOM}|g" "$1" 2>/dev/null
  sed -i '' "s|\[VERSION_HAND\]|${VERSION_HAND}|g" "$1" 2>/dev/null

  # Feature toggles
  sed -i '' "s|'\[SHOW_INSTALLATION_GUIDE\]'|${SHOW_INSTALLATION_GUIDE:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_UPGRADE_GUIDE\]'|${SHOW_UPGRADE_GUIDE:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_GENESIS\]'|${SHOW_GENESIS:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_CLI\]'|${SHOW_CLI:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_ENDPOINTS\]'|${SHOW_ENDPOINTS:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_STATE_SYNC\]'|${SHOW_STATE_SYNC:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_SNAPSHOT\]'|${SHOW_SNAPSHOT:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_LIVE_PEERS\]'|${SHOW_LIVE_PEERS:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_SEED\]'|${SHOW_SEED:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_ADDRESS_BOOK\]'|${SHOW_ADDRESS_BOOK:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_EXPLORERS_LIST\]'|${SHOW_EXPLORERS_LIST:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_PUBLIC_ENDPOINTS\]'|${SHOW_PUBLIC_ENDPOINTS:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_USEFUL_TOOLS\]'|${SHOW_USEFUL_TOOLS:-false}|g" "$1" 2>/dev/null
  sed -i '' "s|'\[SHOW_UPGRADE_WATCHER\]'|${SHOW_UPGRADE_WATCHER:-false}|g" "$1" 2>/dev/null
}

function replacePageVariablesLinux {
  # App
  sed -i "s|\[CHAIN_NAME\]|${CHAIN_NAME}|g" "$1" 2>/dev/null
  sed -i "s|\[CHAIN_SYSTEM_NAME\]|${CHAIN_SYSTEM_NAME}|g" "$1" 2>/dev/null
  sed -i "s|\[CHAIN_ICON\]|${CHAIN_ICON}|g" "$1" 2>/dev/null
...
function replacePageVariables {
  if [[ "$OSTYPE" == "darwin"* ]]; then
    replacePageVariablesMacOs $1
  else
    replacePageVariablesLinux $1
  fi
}
